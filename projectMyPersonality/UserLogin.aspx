        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <input type="text" name="test[0].fullname" id="fullname" autocomplete="off" class="form-control" title="only allowed the alphabet without space." style="margin: 3%; width: 500px;"/>
                        <label style="font-family: Good Feeling Sans Demo;">E-Mail:</label>
                        <input type="email" name="test[0].email" id="email" title="ex email : emailname@hostname.com" autocomplete="off" class= "form-control validate" style="margin: 3%; width: 500px;" pattern="[a-z0-9._%+-]+@[a-z0-9._]+\.[a-z]{2, 3}$"/>
